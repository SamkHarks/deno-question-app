...
const listQuestionsWithOptions = async () => {
    const res = await executeQuery("select q1.id as question_id from questions as q1,question_answer_options as q2 where q1.id = q2.question_id and q2.is_correct = true;");
    return res.rows;
};
